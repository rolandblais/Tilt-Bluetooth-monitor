...
secDelay = 0 #pause for network to spin up, usually 60
...
def main():
        ...
        global screen
        updateSecs = 60  #time in seconds between updating the google sheet
        #screenSecs = 60
        ...
        while True:
                ...
                draw.text((x, top+16),"Temp:" + str(tempf) + "f",  font=font, fill=255)
                draw.text((x, top+46),(datetime.datetime.now().strftime('%H:%M:%S')),  font=font, fill=255)
                disp.image(image)
                disp.display()
        ...
        #	disp.display()
				...
				print r.text
        			...
        			print r.text
        			#brewstat.us
        			r = requests.post('https://Change.this.to.the.URL.of.your.brewstat.log/exec', data)
        			print r.text
